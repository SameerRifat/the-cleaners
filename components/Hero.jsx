...
const SlideContent = ({ image }) => {
    ...
    return (
        <div
        className='h-[30vh] xxxs:h-[32vh] xs:h-[40vh] sm:h-[50vh] md:h-[55vh] lg:h-[80vh] w-full'
        >
            <Image
                src={image}
                alt="banner"
    ...
    return (
        <header className=''>
            <div
                ...
                className='h-[30vh] xxxs:h-[32vh] xs:h-[40vh] sm:h-[50vh] md:h-[55vh] lg:h-[80vh] w-full relative'
            >

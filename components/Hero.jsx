...
const Hero = () => {
    ...
    return (
        <div>
            <div className='h-[25vh] xxs:h-[30vh] xs:h-[40vh] sm:h-[50vh] lg:h-[80vh] w-full relative'>
                <Image
                ...
                <div className='w-full h-full absolute top-0 left-0 flex items-center'>
                    <div className='shared_container flex flex-col h-fit '>
                        ...
                        <h1
                            className='font-medium xxs:font-semibold xs:font-bold text-sm xxxs:text-lg xxs:text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl hidden xxxs:flex xs:hidden flex-col gap-0 xxs:gap-1.5 xs:gap-2 leading-none my-1 md:my-4 lg:my-6'
                        >
                            <span>
                                The Reliable Solution to all your
                            </span>
                        ...
                        <Link
                            href="#contact"
                            className="group w-fit bg-yellow-500 text-white font-medium text-xs xxs:text-sm xs:text-base px-3 xxs:px-4 xs:px-5 sm:px-6 md:px-7 py-2 xxs:py-2.5 md:py-3 rounded-sm flex items-center justify-between gap-1 xs:gap-2

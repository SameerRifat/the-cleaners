...
const Hero = () => {
    ...
    return (
        <div>
            <div className='h-[30vh] xxxs:h-[34vh] xs:h-[40vh] sm:h-[50vh] lg:h-[80vh] w-full relative'>
                <Image
                ...
                <div className='w-full h-full absolute top-0 left-0 flex items-center'>
                    <div className='shared_container flex flex-col h-fit '>
                        ...
                        <h1
                            className='font-medium xxxs:font-semibold xs:font-bold text-lg xxs:text-xl xs:text-2xl sm:text-3xl md:text-4xl lg:text-5xl hidden xxxs:flex xs:hidden flex-col gap-0 xxs:gap-1.5 xs:gap-2 leading-none my-5 md:my-4 lg:my-6'
                        >
                            <span>
                                The Reliable Solution to all your
                            </span>

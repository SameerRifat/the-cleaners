            ...
            <div className='h-[25vh] xxs:h-[30vh] xs:h-[40vh] sm:h-[50vh] lg:h-[80vh] w-full relative'>
                ...
                <div className='w-full h-full absolute top-0 left-0 flex items-center'>
                    <div className='shared_container flex flex-col h-fit '>
                        ...
                        >
                            <span className='hidden xxs:'>Explore</span> Our Services{" "}
                            <ArrowForwardIcon className=" xxs:opacity-80 group-hover:translate-x-1 transition-all" fontSize={isSmallScreen ? 'small' : 'medium'} style={xs ? {fontSize: '12px'} : {}} />
                        </Link>
                    </div>
                </div>
            </div>

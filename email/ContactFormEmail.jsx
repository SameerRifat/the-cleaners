...
const ContactFormEmail = ({ message, senderEmail, senderName, senderPhone, service }) => {
          ...
          <Container>
            <Section className="bg-white borderBlack my-10 px-10 py-4 rounded-md">
              <Heading className="leading-tight font-semibold text-base">
                New message from TheCleaners site
              </Heading>
              <Text>
                <h3 className="text-base font-medium"><span className="font-semibold">Service: </span> {service}</h3>
              </Text>
              <Text>
